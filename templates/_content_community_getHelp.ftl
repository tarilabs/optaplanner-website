    ...
    <@parent.layout>
        ...
        <div class="row">
            <div class="col-auto">
                <div class="sect1">
                    ...
                    <div class="sectionbody">
                        <div class="paragraph">
                            <p>Our friendly volunteer community regularly answers OptaPlanner questions on
                                StackOverflow.</p>
                        </div>
                    </div>
                </div>
                <div><a class="btn btn-lg btn-secondary"
                        href="https://stackoverflow.com/questions/tagged/optaplanner">
                ...
                <div class="paragraph">
                    <p>To get a helpful answer, follow <a href="https://stackoverflow.com/help/how-to-ask">the
                            StackOverflow guidelines</a> such as:</p>
                </div>
                <div class="ulist">
                    <ul>
                        <li>
            ...
            <div class="col-auto">
                ...
                <div>
                    <a class="btn btn-lg btn-secondary" href="${config.issueTracker}">
                        <div>
        ...
        <div class="row">
            <div class="col-auto">
                <div class="sect1">
                    ...
                    <div class="sectionbody">
                        <div class="paragraph">
                            <p>If you&#8217;re working on a contribution or want to start an opinionated discussion,
                                join our discussion forum
                                or mail directly through <a href="mailto:optaplanner-dev@googlegroups.com">optaplanner-dev@googlegroups.com</a>.
                            </p>
                        </div>
                    </div>
                </div>
                <div><a class="btn btn-lg btn-secondary" href="${config.googleGroupURL}">
                        <div>
                ...
                <div>
                    <div>
                        <div class="sect1">
                            ...
                            <div class="sectionbody">
                                <div class="paragraph">
                                    <p>Red Hat offers support for Red Hat Decision Manager and Red Hat Process
                                        Automation Manager. Both enterprise products include OptaPlanner. For a fast and
                                        detailed answer, open a support case with Red Hat.</p>
                                </div>
                                <div class="paragraph">
                                    <p>Red Hat sponsors this open source project by employing its core developers.
                                        They have a dedicated QA and support team around the enterprise version of this
                                        project.</p>
                                </div>
                            </div>
                        </div>
                        <div><a class="btn btn-lg btn-secondary"
                            ...
                            <div class="small">
                                <div class="paragraph">
                                    <p>This requires <a href="${content.rootpath}product/services.html">a paid support
                                            subscription</a>.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="sectionbody">
                    <div class="paragraph">
                        <p>To follow our development discussions,
                            join the <a href="https://kie.zulipchat.com/#narrow/stream/232679-optaplanner">#optaplanner
                                stream on KIE Zulip</a>.</p>
                    </div>
                </div>
            </div>
        </div>
